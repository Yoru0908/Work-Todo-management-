...
export function TasksPage({ t, user, tasks, locale }: TasksProps) {
  ...
  const content = `
    <div class="page-header">
      <h2>${t.taskList}</h2>
      <button class="btn btn-primary" onclick="console.log('openTaskModal clicked'); if(typeof openTaskModal==='function'){openTaskModal();}else{alert('openTaskModal not found');}">
